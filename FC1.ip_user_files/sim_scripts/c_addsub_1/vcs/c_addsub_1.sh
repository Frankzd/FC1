...
compile()
{
  ...
  vhdlan -work xil_defaultlib $vhdlan_opts \
    "$ref_dir/../../../../FC1.srcs/sources_1/ip/c_addsub_1/sim/c_addsub_1.vhd" \
  2>&1 | tee -a vhdlan.log
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.c_addsub_1 -o c_addsub_1_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./c_addsub_1_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key c_addsub_1_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log 64 AN.DB csrc c_addsub_1_simv.daidir)
