...
HD_PWD='D:/project/OPU/OPU_VHDL/FC1/FC1.runs/ram0_3200_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ram0_3200_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ram0_3200_2.tcl
