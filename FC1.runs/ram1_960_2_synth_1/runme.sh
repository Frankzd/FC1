...
HD_PWD='D:/project/OPU/OPU_VHDL/FC1/FC1.runs/ram1_960_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ram1_960_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ram1_960_2.tcl
