...
HD_PWD='D:/project/OPU/OPU_VHDL/FC1/FC1.runs/c_addsub_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log c_addsub_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source c_addsub_1.tcl
